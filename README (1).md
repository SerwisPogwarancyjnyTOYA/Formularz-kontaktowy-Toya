...
## v51 — mobile rescue + PWA

- dodany krytyczny CSS inline, żeby mobile nie wyglądał jak surowy HTML, gdy `app.css` nie dojedzie z cache/404,
- dodany prosty service worker,
- poprawiony manifest PWA,
- opis ścieżki APK w `APP_ANDROID.md`.
