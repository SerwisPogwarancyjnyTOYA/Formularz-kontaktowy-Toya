...
if (!config.includes('20260711-v82-real-drawing-quality-gate')) errors.push('config.js version mismatch');
...
if (!app.includes('isCustomerVisiblePdfV82')) errors.push('app.js v82 real drawing quality gate missing');
if (errors.length) { console.error(errors.join('\n')); process.exit(1); }
console.log('PGW selfcheck OK — 20260711-v82-real-drawing-quality-gate');
