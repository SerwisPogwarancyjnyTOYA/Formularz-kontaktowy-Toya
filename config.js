window.PGW_CONFIG = {
  version: '20260712-v95-v83-v94-master-publication-update',
  appName: 'Formularz zapytania o części',
  recipientEmail: 'service@yato.pl',
  storageMode: 'drive',
  releaseChannel: 'stable-v95',
  ...
  dataUrls: {
    ...
    driveMap: ['data/drive-drawings-map.generated-v95.json', 'data/drive-drawings-map.generated-v84.json', 'data/drive-drawings-map.generated-v83.json'],
