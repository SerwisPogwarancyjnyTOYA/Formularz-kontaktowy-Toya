# PGW Service Hub v57 — ZUN + zestawy w mailu

Wersja porządkuje ekran klienta i dodaje relacje składnik ↔ komplet/zestaw.

Najważniejsze:

- usunięte stare napisy z UI typu v53/v49,
- brak tekstu „urządzenie spoza aktualnej bazy” tam, gdzie jest PDF z Drive,
- ZUN-y dopisują się do maila automatycznie,
- części będące składnikiem kompletu pokazują ostrzeżenie w koszyku i mailu,
- przykład: `ZY828390-103` jest składnikiem `ZY828390-105A` — POMPKA OLEJU KOMPLETNA.
